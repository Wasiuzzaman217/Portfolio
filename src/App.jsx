...
import { Mail, FileText, Sparkles, Code2, ExternalLink, CheckCircle, Send, ArrowUpRight } from 'lucide-react';
          ...
          {projects.map((project, index) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-indigo-400 font-mono mb-3">{project.tagline}</p>
